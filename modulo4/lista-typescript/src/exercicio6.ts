// Agora, pediram para você ajudar a fazer uma funcionalidade
// de um banco digital. Antes de explicar a sua tarefa, você
// precisa entender como eles guardam as contas dos clientes.
// Basicamente, eles salvam o nome do clientes, o saldo total
// e uma lista contendo todas os débitos realizados pelo cliente. 
// Exemplo:
