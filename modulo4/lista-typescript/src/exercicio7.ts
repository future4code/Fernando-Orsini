// Você acabou de conseguir um emprego em uma importadora e 
// precisa continuar a desenvolver o sistema de organização 
// de estoque da empresa. A pessoa desenvolvedora anterior a 
// você chegou a criar uma função que ajusta os preços para o 
// formato brasileiro, mas não chegou a implementa-la:
